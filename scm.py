...
# https://github.com/akekic/causal-component-analysis/blob/main/data_generator/scm.py
...
class MultiEnvLatentSCM(ABC):
    ...
    def __init__(
        ...
        assert (
            adjacency_matrix.shape[0] == adjacency_matrix.shape[1] == latent_dim
        )
...
class LinearSCM(MultiEnvLatentSCM):
    ...
    def __init__(
        ...
        self.functions_per_env, self.inverse_jac_per_env = (
            self.setup_functions_per_env(intervention_targets_per_env)
        )
